...
# M_gi total mass
Mjup_n = optimal_pdf(dn.ms, dn.metal, dn.M_gi); like_Mjup_n = Mjup_n.pdf(); 
Mjup_l = optimal_pdf(dl.ms, dl.metal, dl.M_gi); like_Mjup_l = Mjup_l.pdf(); 
Mjup_h = optimal_pdf(dh.ms, dh.metal, dh.M_gi); like_Mjup_h = Mjup_h.pdf();
...
# Mrock total mass
Mrock_n = optimal_pdf(dn.ms, dn.metal, dn.M_rock); like_Mrock_n = Mrock_n.pdf(); 
Mrock_l = optimal_pdf(dl.ms, dl.metal, dl.M_rock); like_Mrock_l = Mrock_l.pdf(); 
Mrock_h = optimal_pdf(dh.ms, dh.metal, dh.M_rock); like_Mrock_h = Mrock_h.pdf();
...
# Npt total mass
ntp_n = optimal_pdf(dn.ms, dn.metal, dn.n_r); like_ntp_n = ntp_n.pdf(); 
ntp_l = optimal_pdf(dl.ms, dl.metal, dl.n_r); like_ntp_l = ntp_l.pdf();
ntp_h = optimal_pdf(dh.ms, dh.metal, dh.n_r); like_ntp_h = ntp_h.pdf();
